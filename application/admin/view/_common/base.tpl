                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3 list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="/assets/img/mega-menu/mega_icon1.png" alt="" />
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="/assets/img/mega-menu/mega_icon2.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Amaging Dashboard</span>
                                                                <span class="d-desk">Build with BS3</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="/assets/img/mega-menu/mega_icon3.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">3500+ Satisfied Client</span>
                                                                <span class="d-desk">Max 5 star rating</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="/assets/img/mega-menu/mega_icon4.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Easy to Cutomize</span>
                                                                <span class="d-desk">Very easy to use</span>
                                                                </span>
                        ...
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                            ...
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> German </span><img src="/assets/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Italian </span> <img src="/assets/img/flags/italy_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> French </span> <img src="/assets/img/flags/french_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Spanish </span> <img src="/assets/img/flags/spain_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Russian </span> <img src="/assets/img/flags/russia_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="/assets/img/avatar-mini.jpg" alt="">John Doe
                                ...
                                <div class="online-chat-container">
                                    ...
                                    <ul class="team-list chat-list-side">
                                        <li>
                                            ...
                                            <img class="circle" src="/assets/img/img2.jpg" alt="">
                                        ...
                                        <li>
                                            <a href="#">
                                                    <span class="thumb-small">
                                            <img class="circle" src="/assets/img/img3.jpg" alt="">
                                            <i class="online dot"></i>
                                        </span>
                                                <div class="inline">
                                                        <span class="name">
                                        ...
                                        <li>
                                            <a href="#">
                                                    <span class="thumb-small">
                                            <img class="circle" src="/assets/img/img1.jpg" alt="">
                                            <i class="away dot"></i>
                                        </span>
                                                <div class="inline">
                                                        <span class="name">
...
<!--jquery-ui-->
<script src="/assets/js/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
...
<script src="/assets/js/flot-chart/flot-spline.js"></script>
...
<script src="/assets/js/flot-chart/jquery.flot.crosshair.js"></script>


<!--earning chart init-->
<script src="/assets/js/earning-chart-init.js"></script>
...
<!--easy pie chart-->
<script src="/assets/js/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="/assets/js/easy-pie-chart.js"></script>


<!--vectormap-->
<script src="/assets/js/vector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/assets/js/vector-map/jquery-jvectormap-world-mill-en.js"></script>
<script src="/assets/js/dashboard-vmap-init.js"></script>

<!--Icheck-->
<script src="/assets/js/icheck/skins/icheck.min.js"></script>
<script src="/assets/js/todo-init.js"></script>

<!--jquery countTo-->
<script src="/assets/js/jquery-countTo/jquery.countTo.js"  type="text/javascript"></script>
